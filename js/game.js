...
const MINE = getElementHTML(`<img src ="images/mine.png">`, 'mine');
...
function renderBoard(board, selector) {
  ...
  for (var i = 0; i < board.length; i++) {
    ...
    for (var j = 0; j < board[0].length; j++) {
      ...
      strHTML += `<td onclick ="cellClicked(this, ${i}, ${j})" oncontextmenu="cellMarked(event,this, ${i}, ${j})" class="${className}">  </td>`;
    }
    strHTML += '</tr>';
  }
  strHTML += '</tbody></table>';
